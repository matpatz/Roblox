...
export default async function handler_fn(req, res) {
  ...
  if (req.method === 'PUT') {
    ...
    if (body.playUrl !== undefined) updates.play_url = body.playUrl ? validateString(body.playUrl, 'playUrl', { max: 2000 }) : null;
    ...
    if (body.playButtonText !== undefined) updates.play_button_text = validateString(body.playButtonText, 'playButtonText', { max: 50 });
