--[[task.spawn(function()
    ...
    local discord_link = loadstring(game:HttpGet("https://sneekysscripts.uk/Scripts/FOV_LIBRARY/info.luau"))().discord_link;
    ...
    for i = 6463, 6472, 1 do
        ...
        if s and r and r.StatusCode == 200 then break; end;
    end;
end);]]
